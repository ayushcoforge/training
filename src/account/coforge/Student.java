...
public String toString() {
	return "Student [sname=" + sname + ", sid=" + sid + ","+ address +"]";
}
	...
	public static void main(String[] args) {
		CollegeAddress ad= new CollegeAddress("hyd","tel",4578);
		Student s1= new Student("Ayush",123);
		s1.setAddress(ad);
		System.out.println(s1);
		Student s2= new Student("xyz",678);
